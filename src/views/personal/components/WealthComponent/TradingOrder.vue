<template>
  <div class="trading__order wealth__material">
    <el-table
      :data="tableData"
    ...
    >
      ...
      >
        <div slot-scope="scope" class="operation__info">
          <p class="operation__type">{{ scope.row.operationType }}</p>
          <p class="operation__des">{{ scope.row.operationInfo }}</p>
        </div>
      </el-table-column>
      <el-table-column
        prop="moeny"
